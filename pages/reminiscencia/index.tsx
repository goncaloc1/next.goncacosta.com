      ...
      slides={[
        ...
        <Carousel.Slide>
          <div className={styles.text_wrapper}>
            ...
            <p>
              like a mother who lays her newborn on her breast without waking
              it.
            </p>
        ...
        <Carousel.Slide>
          <div className={styles.text_wrapper}>
            ...
            <p>
              when we first came to Buenos Aires, but now I know that I can’t.”
              I
            </p>
            <p>
              said, “Why?” He said, “Because I think that memory” - I don’t know
              if
            </p>
            <p>
              this was his own theory, I was so impressed by it that I didn’t
              ask him
            </p>
            <p>
              whether he found it or whether he evolved it - but he said, “I
              think that
            </p>
            <p>
              if I recall something, so example, if today I look back on this
              morning,
            </p>
            <p>
              then I get an Photo of what I saw this morning. But if tonight,
              I’m
            </p>
            <p>
              thinking back on this morning, then I’m really recalling not the
              first
            </p>
            <p>
              Photo, but the first Photo in memory. So that every time I recall
            </p>
            <p>
              something, I’m not recalling it really, I’m recalling the last
              time I
            </p>
            <p>
            ...
            <p>
              have no Photos whatever, about my childhood, about my youth. And
            </p>
            <p>
              then he illustrated that, with a pile of coins. He piled one coin
              on top of
            </p>
            <p>
              the other and said, “Well, now this first coin, the bottom coin,
              this
            </p>
            <p>
              would be the first Photo, for example, of the house of my
              childhood.
            </p>
            <p>
              Now this second would be a memory I had of that house when I went
              to
            </p>
            <p>
              Buenos Aires. Then the third one another memory and so on. And as
              in
            </p>
            <p>
            ...
            <p>
              memory of today ties in with the first Photos I had,” so that, he
              said, “I
            </p>
            <p>
              try not to think of things in the past because if I do I’ll be
              thinking back
            </p>
        ...
        <Carousel.Slide>
          <div className={styles.text_wrapper}>
            ...
            <p>
              inexhaustible well. Yet everything happens only a certain number
              of times, and a
            </p>
            <p>
            ...
            <p>
              afternoon of your childhood, an afternoon that is so deeply a part
              of your being
            </p>
            <p>
            ...
            <p>
              more, perhaps not even that. How many more times will you watch
              the full moon
            </p>
