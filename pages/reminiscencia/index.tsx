...
const slides: any = [
  ...
  />,
  <div>
    <p>For a long time, life deals with the still-tender memory of childhood</p>
  ...
  <div>
    ...
    <p>very saddening thing. He said, “I thought I could recall my childhood</p>
    <p>when we first came to Buenos Aires, but now I know that I can’t.” I</p>
    <p>said, “Why?” He said, “Because I think that memory” - I don’t know if</p>
    <p>
    ...
    <p>something, I’m not recalling it really, I’m recalling the last time I</p>
    <p>
    ...
    <p>the other and said, “Well, now this first coin, the bottom coin, this</p>
    <p>would be the first image, for example, of the house of my childhood.</p>
    <p>Now this second would be a memory I had of that house when I went to</p>
    <p>Buenos Aires. Then the third one another memory and so on. And as in</p>
  ...
  />,
  <div>
    <p>Because we don’t know when we will die, we get to think of life as an</p>
    <p>
    ...
    <p>
      afternoon of your childhood, an afternoon that is so deeply a part of your
      being
    </p>
    <p>
