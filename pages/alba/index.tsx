    ...
    <>
      <Box>
        ...
        <div className={styles.title}>
          <div className={styles.title_left}>Alba</div>
      ...
      <Box photoSrc={photoc} />
      <Box photoSrc={photod} />
      <Box className={`box ${styles.box_text}`}>
      ...
      <Box className={`box ${styles.box_text}`}>
        06.06.11
        <br />
        "(...)Lembro-me de mim no terminal em Santiago deu-me lágrimas, um fim,
        outro fim. <br />
        Quero casa, embora não saiba muito bem o que significa isso.
        <br />
        Talvez mordomias. E estas esgotam-se muito depressa. Tenho a certeza.{" "}
        <br />
        Depois de uma semana quererei algo mais. E neste preciso momento sinto
        que quero assentar. <br />
        Já ontem senti isso e outros tantos dias atrás. Assentar mas não parar.{" "}
        <br />
        Será que serei suficientemente fiel a uma mulher mesmo que a ame?
        <br />
